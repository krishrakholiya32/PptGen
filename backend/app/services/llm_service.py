...
class LLMService:
    """
    Primary: Groq (llama-3.3-70b) — free, fast, excellent quality
    Vision:  Groq (llama-3.2-11b-vision) — free, analyzes images/slides
    Fallback: Gemini (gemini-1.5-flash) — free tier 1500 req/day
    """
